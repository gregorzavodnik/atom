...
4. Atomenergie in Deutschland (historisch + aktuell)
5. Chancen und Risiken
6. Lokale und globale Konflikte
7. Bewertung mit Viereck der Nachhaltigkeit
...
- Quellen werden zentral in /content/sources.json gepflegt
- KEINE erfundenen Quellen, KEINE halluzinierten Zahlen
- Wenn eine Information fehlt: deutlich als TODO markieren, nicht raten
