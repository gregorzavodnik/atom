...
// ─── Typen ─────────────────────────────────────────────────────────────────
// Konsolidiert aus den vormaligen lib/timeline-types.ts und components/timeline/*.
// Der Inhalt (ITEMS) wurde mechanisch über den alten Markdown-Parser erzeugt und
// wird hier wörtlich übernommen, damit das gerenderte DOM byte-genau identisch bleibt.

type TimelineItemStatus = 'done' | 'current' | 'upcoming'

type TimelineItem = {
   id: string
   date: string // ISO 8601 (YYYY-MM-DD), für das <time>-Attribut
   dateLabel: string // Anzeige-Label, z. B. "1955–1969"
   title: string
...
const ITEMS: TimelineItem[] = [
   ...
   },
   {
      ...
      descriptionHtml:
         '<ul><li><span>1990</span><strong>Abschaltung der sowjetischen Reaktoren in Greifswald/Lubmin nach der Wiedervereinigung</strong></li><li><span>1991</span><strong>Endgültige Aufgabe des nie betriebenen Schnellen Brüters Kalkar (heute Freizeitpark)</strong></li><li><span>14. Juni 2000</span><strong>Atomkonsens</strong><span> – Vereinbarung zwischen Schröder-Regierung und Energieversorgern über den geordneten Ausstieg</span></li><li><span>27. April 2002</span><strong>Novelle des Atomgesetzes: gesetzliche Verankerung des ersten Atomausstiegs, Begrenzung der Reststrommengen</strong></li><li><span>Datum unbekannt</span><strong>Ereignis</strong></li></ul>',
      status: 'upcoming',
   },
   {
      id: 'phase-5',
      ...
      descriptionHtml:
         '<ul><li><span>2003</span><strong>Abschaltung Stade</strong><span> – erstes KKW nach dem Konsens vom Netz</span></li><li><span>2005</span><strong>Abschaltung Obrigheim</strong></li><li><span>Oktober 2010</span><strong>Laufzeitverlängerung durch Schwarz-Gelb (Merkel/Westerwelle)</strong><span> – im Schnitt rund 12 Jahre längere Restlaufzeiten</span></li><li><span>11. März 2011</span><strong>Reaktorkatastrophe von Fukushima (Japan)</strong></li><li><span>14. März 2011</span><strong>Atom-Moratorium</strong><span> – sofortige vorübergehende Abschaltung der acht ältesten Reaktoren</span></li><li><span>30. Juni 2011</span><strong>Bundestag beschließt mit breiter Mehrheit den endgültigen Atomausstieg bis Ende 2022 (13. Atomgesetz-Novelle)</strong></li><li><span>Datum unbekannt</span><strong>Ereignis</strong></li></ul>',
      status: 'upcoming',
   },
   {
      id: 'phase-6',
...
// ─── Einzelne Zeitstrahl-Zeile (vormals TimelineItemCard) ────────────────────
...
function TimelineRow({ item, index, isFirst, isLast }: RowProps) {
...
// ─── Karte (vormals Card in TimelineItemCard) ────────────────────────────────
      ...
      <article className="rounded-xl border border-stone-200 bg-white p-5 shadow-sm hover:shadow-md hover:border-stone-300 transition-all duration-200 focus-within:ring-2 focus-within:ring-stone-400 focus-within:ring-offset-2">
         ...
         {item.descriptionHtml && (
            <div
               ...
               // Sicher: HTML stammt aus unserem eigenen Parser auf Basis einer vertrauenswürdigen lokalen .md-Datei, nie aus Nutzereingaben
